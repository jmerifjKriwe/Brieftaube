...
documents under [`concepts/`](concepts/) are the translated source material
...
| [`agents/`](agents/) | Deep-dive context files, read on demand per task |
| [`adr/`](adr/) | Architecture Decision Records |
| [`concepts/`](concepts/) | Source material: requirements, architecture, data model, API spec, roadmap |
...
- **Building a feature:** the matching [`agents/`](agents/) page plus the
  concept document for the domain in question.
- **Deciding something architectural:** read [`adr/`](adr/) first — if the
